...
void main() async{
  ...
  await Firebase.initializeApp(
      options: const FirebaseOptions(
        apiKey: 'AIzaSyBjqWMjAZFUxt47pxt8XXFPwxw2dHJd1rc',
        appId: '1:617360211631:android:eb7364d4c2edfb94651e5a',
        messagingSenderId: 'sendid',
        projectId: 'esoftfirebase-ea401',
        storageBucket: 'esoftfirebase-ea401.firebasestorage.app',
      )
  );
  runApp(const MyApp());
}
